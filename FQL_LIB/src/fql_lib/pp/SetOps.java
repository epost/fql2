...
import fql_lib.pp.FnExp.Case;
import fql_lib.pp.FnExp.Chr;
import fql_lib.pp.FnExp.Comp;
import fql_lib.pp.FnExp.Const;
import fql_lib.pp.FnExp.Curry;
import fql_lib.pp.FnExp.Eval;
import fql_lib.pp.FnExp.FF;
import fql_lib.pp.FnExp.FnExpVisitor;
import fql_lib.pp.FnExp.Fst;
import fql_lib.pp.FnExp.Id;
import fql_lib.pp.FnExp.Inl;
import fql_lib.pp.FnExp.Inr;
import fql_lib.pp.FnExp.Iso;
import fql_lib.pp.FnExp.Krnl;
import fql_lib.pp.FnExp.Prod;
import fql_lib.pp.FnExp.Snd;
import fql_lib.pp.FnExp.TT;
import fql_lib.pp.FnExp.Tru;
import fql_lib.pp.FnExp.Var;
import fql_lib.pp.SetExp.Cod;
import fql_lib.pp.SetExp.Dom;
import fql_lib.pp.SetExp.Exp;
import fql_lib.pp.SetExp.Numeral;
import fql_lib.pp.SetExp.One;
import fql_lib.pp.SetExp.Plus;
import fql_lib.pp.SetExp.Prop;
import fql_lib.pp.SetExp.Range;
import fql_lib.pp.SetExp.SetExpVisitor;
import fql_lib.pp.SetExp.Times;
import fql_lib.pp.SetExp.Zero;
...
public class SetOps implements SetExpVisitor<Set<?>, FQLPPProgram>, FnExpVisitor<FinSet.Fn, FQLPPProgram> , Serializable {
	...
	@Override
	public Set<?> visit(FQLPPProgram env, fql_lib.pp.SetExp.Var e) {
	...
	@Override
	public Set<?> visit(FQLPPProgram env, fql_lib.pp.SetExp.Const e) {
		return e.s;
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public Set<?> visit(FQLPPProgram env, fql_lib.pp.SetExp.Apply e) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public Fn visit(FQLPPProgram env, fql_lib.pp.FnExp.Apply e) {
		FunctorExp k = env.ftrs.get(e.f);
		if (k == null) {
			throw new RuntimeException("Missing functor: " + k);
		}
	...
	@SuppressWarnings("unchecked")
	@Override
	public Fn visit(FQLPPProgram env, fql_lib.pp.FnExp.ApplyTrans e) {
