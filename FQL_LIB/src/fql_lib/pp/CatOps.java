...
import fql_lib.pp.FunctorExp.Apply;
import fql_lib.pp.FunctorExp.Case;
import fql_lib.pp.FunctorExp.CatConst;
import fql_lib.pp.FunctorExp.Comp;
import fql_lib.pp.FunctorExp.Curry;
import fql_lib.pp.FunctorExp.Eval;
import fql_lib.pp.FunctorExp.FF;
import fql_lib.pp.FunctorExp.FinalConst;
import fql_lib.pp.FunctorExp.Fst;
import fql_lib.pp.FunctorExp.FunctorExpVisitor;
import fql_lib.pp.FunctorExp.Id;
import fql_lib.pp.FunctorExp.Inl;
import fql_lib.pp.FunctorExp.Inr;
import fql_lib.pp.FunctorExp.InstConst;
import fql_lib.pp.FunctorExp.Iso;
import fql_lib.pp.FunctorExp.MapConst;
import fql_lib.pp.FunctorExp.Migrate;
import fql_lib.pp.FunctorExp.Pivot;
import fql_lib.pp.FunctorExp.Prod;
import fql_lib.pp.FunctorExp.Prop;
import fql_lib.pp.FunctorExp.Pushout;
import fql_lib.pp.FunctorExp.SetSetConst;
import fql_lib.pp.FunctorExp.Snd;
import fql_lib.pp.FunctorExp.TT;
import fql_lib.pp.FunctorExp.Uncurry;
import fql_lib.pp.FunctorExp.Var;
import fql_lib.pp.TransExp.Adj;
import fql_lib.pp.TransExp.AndOrNotImplies;
import fql_lib.pp.TransExp.ApplyPath;
import fql_lib.pp.TransExp.ApplyTrans;
import fql_lib.pp.TransExp.Bool;
import fql_lib.pp.TransExp.Chr;
import fql_lib.pp.TransExp.Inj;
import fql_lib.pp.TransExp.Ker;
import fql_lib.pp.TransExp.PeterApply;
import fql_lib.pp.TransExp.Proj;
import fql_lib.pp.TransExp.SetSet;
import fql_lib.pp.TransExp.ToCat;
import fql_lib.pp.TransExp.ToInst;
import fql_lib.pp.TransExp.ToMap;
import fql_lib.pp.TransExp.ToSet;
import fql_lib.pp.TransExp.TransExpVisitor;
import fql_lib.pp.TransExp.Whisker;
import fql_lib.pp.cat.Category;
import fql_lib.pp.cat.CoMonad;
...
public class CatOps implements CatExpVisitor<Category, FQLPPProgram>,
	...
	@Override
	public Category visit(FQLPPProgram env, fql_lib.pp.CatExp.Var e) {
	...
	@Override
	public Category visit(FQLPPProgram env, fql_lib.pp.CatExp.Const e) {
...
//			FQLProgram env2 = new FQLProgram(env);
	...
	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.Id e) {
		Functor ff = e.t.accept(env, this);
		return Transform.id(ff);
	}

	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.Comp e) {
	...
	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.Var e) {
	...
	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.Prod e) {
		Transform l = e.l.accept(env, this);
		Transform r = e.r.accept(env, this);
		if (!l.source.equals(r.source)) {
	...
	@Override
	public Functor visit(FQLPPProgram env, fql_lib.pp.FunctorExp.One e) {
	...
	@Override
	public Functor visit(FQLPPProgram env, fql_lib.pp.FunctorExp.Zero e) {
		Category<?, ?> cat = e.cat.accept(env, this);
		Category<?, ?> amb = e.ambient.accept(env, this);
		if (amb.equals(FinSet.FinSet)) {
	...
	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.One e) {
		Functor F = e.f.accept(env, this);
	...
	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.Zero e) {
		Functor F = e.f.accept(env, this);
		if (F.target.equals(FinSet.FinSet)) {
	...
	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.CoProd e) {
		Transform l = e.l.accept(env, this);
		Transform r = e.r.accept(env, this);
		if (!l.target.equals(r.target)) {
...
//		Signature s = new Signature(src.nodes, src.arrows, src.eqs);
	...
	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.Iso e) {
		Functor l = e.l.accept(env, this);
		Functor r = e.r.accept(env, this);
		if (!l.source.equals(r.source)) {
	...
	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.Curry e) {
	...
	@Override
	public Transform visit(FQLPPProgram env, fql_lib.pp.TransExp.Eval e) {
	...
	@Override
	public Functor visit(FQLPPProgram env, fql_lib.pp.FunctorExp.Dom e) {
