...
public class Patrick23Example extends Example {
	...
	String s = "old : type"
			...
			+ "\nenrich_with = relationalize apply trans_step almost2 //takes 15 minutes"
			+ "\n"
			...
			+ "\n/* QUERY 1"
			+ "\n"
			+ "\n17-4 Stainless Steel, CNC, 88 cm, Ram EDM"
			+ "\nPre-hardened Stainless Steel, Wire EDM, 30 cm, Sinker EDM"
			+ "\n*/"
			+ "\n"
			+ "\nQ1 = FLOWER { "
			+ "\n select"
