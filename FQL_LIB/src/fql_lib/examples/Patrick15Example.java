...
public class Patrick15Example extends Example {
	...
	String s = "//can take 5-10mins"
			...
			+ "\n"
			+ "\n/////////////////// NIST Q1:"
			+ "\n//so far, it's still taking forever to compute these queries, so commented out for now"
			+ "\n/*"
			+ "\nflower { "
			+ "\n select"
			+ "\n  m.Material_Name, "
			...
			+ "\n where"
			+ "\n  c = cm.Capability_ID,"
			+ "\n  uc = c.Max_Length_Unit "
			+ "\n  m = cm.Material_ID "
			+ "\n  c = cc.Capability_ID"
			+ "\n  posc = cc.ProductOrServiceCategory_ID;"
			+ "\n} I  "
			+ "\n*/"
			+ "\n/* "
			+ "\nthe above should also include this where clause:"
			+ "\n"
			+ "\nWHERE "
			+ "\n (Material.Material_Name='Pre-hardened Stainless Steel' Or Material.Material_Name='17-4 Stainless Steel') "
			+ "\nAND"
			+ "\n (Capability.Max_Length>=15) // = 40, 47.25, 18.25 20"
			+ "\nAND "
			+ "\n (UnitCode.Code='cm') "
			+ "\nAND "
