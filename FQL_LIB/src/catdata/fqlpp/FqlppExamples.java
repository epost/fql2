...
import catdata.fqlpp.examples.EmployeeExample;
import catdata.fqlpp.examples.ExpExample;
import catdata.fqlpp.examples.IntegrationExample;
import catdata.fqlpp.examples.MonadExample;
import catdata.fqlpp.examples.NistExampl;
import catdata.fqlpp.examples.PiExample;
import catdata.fqlpp.examples.ProductsExample;
import catdata.fqlpp.examples.PropExample;
import catdata.fqlpp.examples.SetsExample;
import catdata.fqlpp.examples.SigmaExample;
import catdata.fqlpp.examples.VikExample;
import catdata.ide.Example;

public class FqlppExamples {
