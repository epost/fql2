...
public class AqlJdbcExample extends AqlExample {
	...
	String s = 
			...
			+ "\nDROP TABLE IF EXISTS Department;\" //multiple statements can be used, but many SQL engines (such as H2, AQL's internal engine) will only print the output of the first statement, and some require ?allowMultiQueries=true "
			+ "\n"
			...
			+ "\n"
			+ "\n// options"
			+ "\n// 	always_reload=true //true forces this pragma to not be cached between runs"
			+ "\n}  "
			+ "\n"
			+" \n//look at the exampledata"
			+ "\npragma view = exec_jdbc \"org.h2.Driver\" \"jdbc:h2:mem:db1\" { "
			...
			+ "\n}"
			+ "\n"			
			+ "\n//todo: export an instance"
			+ "\n//todo: export a transform"
			+ "\n"
			+ "\n////////////////////////////////////////////////////////////"
			+ "\n//"
