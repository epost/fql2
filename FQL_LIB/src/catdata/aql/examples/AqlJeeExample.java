...
public class AqlJeeExample extends AqlExample {
	...
	String s = "//Example courtesy of Jee Chung"
			...
			+ "\n	java_functions"
			+ "\n		keygen : Integer,Integer -> Integer = \"return (2^input[0] * 3^input[1])\""
			+ "\n}"
			+ "\n"
			+ "\n		"
			+ "\n////////////////////////////////////////////////////////////////////////"
			...
			+ "\n"
			+ "\n	//not identity"
			+ "\n	transactionQ = {for t:transaction p:portfolio c:client c1:client"
			...
			+ "\n			transaction_portfolio = {p = p} : portfolioQ	//NEW	"
			+ "\n	} : transaction"
			+ "\n"
			+ "\n	//not identity"
			...
			+ "\n		 keys portfolio_parent_portfolio = {p=p.portfolio_parent_portfolio} : portfolioQ //added"
			+ "\n		 	portfolio_strategy = {s=p.portfolio_strategy} : strategyQ"
			+ "\n	} : portfolio"
			+ "\n"
			+ "\n	//not identity"
			+ "\n	holdingQ = {for h:holding c:currency a:asset"
			...
			+ "\n		 keys holding_asset = {a = a} : assetQ"
			+ "\n		     holding_currency = {c = c} : currencyQ //NEW"
			+ "\n	} : holding"
			+ "\n   "
			+ "\n	//not identity "
			+ "\n	portfolioholdingQ = {for h:holding p:portfolio cur:currency c1:client a:asset"
			+ "\n		 where a.asset_id = h.holding_asset_id"
			...
			+ "\n		 keys portfolioholding_holding = {h = h c = cur a=a} : holdingQ "
			+ "\n		portfolioholding_client = {c = h.holding_client} : clientQ "
			+ "\n		portfolioholding_portfolio = {p = p} : portfolioQ		"
			+ "\n	} : portfolioholding"
			+ "\n	"
			+ "\n} : Colimit -> Target	"
			+ "\n"
			...
			+ "\n		 keys portfolio_parent_portfolio = {p=p.portfolio_parent_portfolio} : portfolioQ"
			+ "\n		 	portfolio_strategy = {s=p.portfolio_strategy} : strategyQ"
			+ "\n	} : portfolio"
			+ "\n"
			+ "\n	transactionQ = {for t:transaction"
			+ "\n		 where"
			+ "\n		 return transaction_id = t.transaction_id"
			+ "\n			transaction_date = t.transaction_date"
			+ "\n			transaction_portfolio_id = t.transaction_portfolio_id"
			...
			+ "\n		 keys transaction_currency = {c = t.transaction_currency} : currencyQ"
			+ "\n			transaction_asset = {a = t.transaction_asset} : assetQ"
			+ "\n			transaction_portfolio = {p = t.transaction_portfolio} : portfolioQ"
			+ "\n	} : transaction"
			+ "\n"
			+ "\n	clientpositionQ = {for p:position"
			+ "\n		 where"
			...
			+ "\n		 keys clientposition_client = {c = p.position_client} : clientQ"
			+ "\n			clientposition_asset = {a = p.position_asset} : assetQ"
			+ "\n	} : clientposition"
			+ "\n"
			+ "\n	clientportfolioholdingQ = {for ph:portfolioholding"
			+ "\n		 where"
			...
			+ "\n		 keys clientportfolioholding_client = {c = ph.portfolioholding_client} : clientQ"
			+ "\n			clientportfolioholding_asset = {a = ph.portfolioholding_holding.holding_asset} : assetQ"
			+ "\n			clientportfolioholding_portfolio = {p = ph.portfolioholding_portfolio} : portfolioQ"
			+ "\n	} : clientportfolioholding"
			+ "\n"
			+ "\n} : Target -> CycTarget"
			+ "\n"
			+ "\nOutputCyc = apply ETL_Cyc Output "
			+ "\n "
			+ "\nOutputCycDistinct = distinct OutputCyc  "
			+ "\n"
			+ "\n*/"
			+ "\n";
