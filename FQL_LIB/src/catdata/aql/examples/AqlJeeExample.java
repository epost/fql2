...
*/	
	...
	String s = "//Example courtesy of Jee Chung"
			...
			+ "\n} "
			+ "\n//instance ClientInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/Client\" : Client " 
			+ "\n"
			+ "\n////////////////////////////////////////////////////////////////////////"
			+ "\n"
			+ "\n//compile time input"
			...
			+ "\n} "
			+ "\n//instance PortfolioInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/Portfolio\" : Portfolio" 
			+ "\n"
			+ "\n////////////////////////////////////////////////////////////////////////"
			+ "\n"
			+ "\n//compile time input		"
			...
			+ "\n} "
			+ "\n//instance RefInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/Ref\" : Ref" 
			+ "\n"
			+ "\n////////////////////////////////////////////////////////////////////////"
			+ "\n"
			+ "\n//compile time input		"
			...
			+ "\n} "
			+ "\n//instance TransInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/Trans\" : Trans" 
			+ "\n"
			+ "\n////////////////////////////////////////////////////////////////////////"
			+ "\n"
			+ "\n//compile time input"
			...
			+ "\n} "
			+ "\n"
			+ "\n//instance HoldPosInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/HoldPos\" : HoldPos" 
			+ "\n"
			+ "\n////////////////////////////////////////////////////////////////////////"
			...
			+ "\n} "
			+ "\n//instance ClientHoldPosLinkageInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/ClientHoldPos\" : ClientHoldPosLinkage" 
			+ "\n"
			+ "\n//computed at compile time"
			...
			+ "\n		dick -> cc2"
			+ "\n} "
			+ "\n//transform ClientHoldPosLinkageInstanceToClientInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/ClientHoldPos/toClient.csv\" : Sigma_ClientHoldPosLinkageToClient_ClientHoldPosLinkageInstance -> ClientInstance"
			+ "\n"
			+ "\n//computed at compile time"
			...
			+ "\n		dick -> hpc2"
			+ "\n} "
			+ "\n//transform ClientHoldPosLinkageInstanceToHoldPosInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/ClientHoldPos/toHoldPos.csv\" : Sigma_ClientHoldPosLinkageToHoldPos_ClientHoldPosLinkageInstance -> HoldPosInstance"
			+ "\n"
			+ "\n"
			+ "\n/////////////////////////////////////////////////////////////////////////////////////////////////////////////////"
			+ "\n"
			...
			+ "\n} "
			+ "\n//instance PortfolioRefLinkageInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/PortfolioRef\" : PortfolioRefLinkage"	
			+ "\n"
			+ "\n"
			+ "\n//computed at compile time"
			...
			+ "\n		strat3 -> ps3"
			+ "\n} "
			+ "\n//transform PortfolioRefLinkageInstanceToPortfolioInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/PortfolioRef/toPortfolio.csv\" : Sigma_PortfolioRefLinkageToPortfolio_PortfolioRefLinkageInstance -> PortfolioInstance"
			+ "\n"
			+ "\n//computed at compile time"
			...
			+ "\n		strat3 -> rs3"
			+ "\n} "
			+ "\n//transform PortfolioRefLinkageInstanceToRefInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/PortfolioRef/toRef.csv\" : Sigma_PortfolioRefLinkageToRef_PortfolioRefLinkageInstance -> RefInstance"
			+ "\n"
			+ "\n////////////////////////////////////////////////////////////////////////"
			+ "\n"
			+ "\n//compile time input"
			...
			+ "\n} "
			+ "\n//instance RefTransLinkageInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/RefTrans\" : RefTransLinkage "	
			+ "\n"
			+ "\n"
			+ "\n//computed at compile time"
			...
			+ "\n		nine -> ra9"
			+ "\n} "
			+ "\n//transform RefTransLinkageInstanceToRefInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/RefTrans/toRef.csv\" : Sigma_RefTransLinkageToRef_RefTransLinkageInstance -> RefInstance"
			+ "\n"
			+ "\n//computed at compile time"
			...
			+ "\n		nine -> ta9"
			+ "\n} "
			+ "\n//transform RefTransLinkageInstanceToTransInstance = import_csv \"/Users/ryan/github/fql2/FQL_LIB/examples/finance/RefTrans/toTrans.csv\" : Sigma_RefTransLinkageToTrans_RefTransLinkageInstance -> TransInstance "
			+ "\n"
			+ "\n"
			+ "\n////////////////////////////////////////////////////////////////////////"
