...
public final class AqlViewer {
	...
	public static JComponent view(Kind kind, Object obj) {
		...
		case INSTANCE:
			...
			ret.add(new CodeTextPanel("", instance.semantics().talg().toString()), "TAlg");
			break;
		case MAPPING:
	...
	private static <Ty,En,Sym,Fk,Att,Gen,Sk,X,Y> Component tables(Algebra<Ty,En,Sym,Fk,Att,Gen,Sk,X,Y> alg) {
