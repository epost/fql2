...
public class SqlToOpl extends JPanel {
	...
	void doRun() {
		...
		Pair<OplSchema<Chc<SqlType, SqlTable>, Chc<Object, Chc<SqlColumn, SqlForeignKey>>, String>, OplInst<Chc<SqlType, SqlTable>, Chc<Object, Chc<SqlColumn, SqlForeignKey>>, String, String>> 
		x = convert(input.schema, input.instance, "S0", "I0");
		
		String ret = "S0 = " + x.first.sig;
		ret += "\n\nS = " + x.first;
		ret += "\n\nI0 = " + x.second.P;
	...
	public static Pair<OplSchema<Chc<SqlType, SqlTable>, Chc<Object, Chc<SqlColumn, SqlForeignKey>>, String>,
	OplInst<Chc<SqlType, SqlTable>, Chc<Object, Chc<SqlColumn, SqlForeignKey>>, String, String>> 
	convert(SqlSchema info, SqlInstance inst, String S0, String I0) {
...
//					OplTerm<Chc<String, String>, String> rhs = new OplTerm<>(Chc.inChc.inRight(tgen), new LinkedList<>());
