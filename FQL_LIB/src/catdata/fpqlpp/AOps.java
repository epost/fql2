...
import catdata.fpqlpp.AExp.AExpVisitor;
import catdata.opl.OplEnvironment;
import catdata.opl.OplObject;

public class AOps implements AExpVisitor<OplObject, AProgram>  {
	
	OplEnvironment ENV;

	public AOps(OplEnvironment env) {
		this.ENV = env;
	}
/*
	@Override
