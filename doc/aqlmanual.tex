...
\title{AQL Reference Manual - Draft}
...
The AQL IDE will cache result artifacts to save time in subsequent executions; this behavior can be disabled per-expression through the {\tt always\_reload} option.  Disabling caching is can be useful when and AQL program contains side-effecting pragmas.
...
\subsubsection{{\tt program_allow_nontermination_unsafe}}
